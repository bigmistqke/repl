    ...
    mapArray(
      ...
      path => {
        ...
        const transformed = createAsync(async () => {
          var _a, _b
          return (
            ((_b = (_a = extensions2[extension]) == null ? void 0 : _a.transform) == null
              ? void 0
              : _b.call(_a, { path, source: fs()[path], executables })) || fs()[path]
          )
        })
...
function createFileSystem(extensions2) {
        ...
        .map(([path2, file]) => {
          ...
          return {
            type:
              file === null
                ? 'dir'
                : ((_a = extensions2[getExtension(path2)]) == null ? void 0 : _a.type) || 'plain',
            path: path2,
          }
        })
    }
  ...
  const api = {
    ...
    getType(path) {
      ...
      return fs[path] === null
        ? 'dir'
        : ((_a = extensions2[getExtension(path)]) == null ? void 0 : _a.type) || 'plain'
    },
    readdir,
    mkdir(path, options) {
      path = normalizePath$1(path)
